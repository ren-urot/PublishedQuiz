...
export default function Navbar({ variant = 'cpd' }: Props) {
  ...
  return (
    <header className={`sticky top-0 z-40 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 ${variant === 'maclean' ? 'border-[#ff9f4b]' : 'border-border'}`}>
